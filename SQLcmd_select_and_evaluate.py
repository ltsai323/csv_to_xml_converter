...
senthic_str = { '1':300, '2':200, '3':120, '4':300, '5':200, '6':120 } ### output is a "real"
...
if __name__ == '__main__':
    ...
    try:
        ...
        helpmesg = f'\n\n[Usage] python3 thisfile.py task1.search_null_geometry.sql task1.evaluate_geometry.sql\n\n'
        raise Exception(helpmesg) from e
